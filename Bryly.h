...
public:
     ...
     */
    Trojkat(Wektor3D kolor, Wektor3D v0, Wektor3D v1, Wektor3D v2, Wektor3D n0, Wektor3D n1, Wektor3D n2, float lustrzanosc = 0.0f, float metalicznosc = 0.0f, float moc_emisji = 0.0f)
        : Obiekt3D(kolor), v0_(v0), v1_(v1), v2_(v2), n0_(n0), n1_(n1), n2_(n2), lustrzanosc_(lustrzanosc), metalicznosc_(metalicznosc), moc_emisji_(moc_emisji) {};
