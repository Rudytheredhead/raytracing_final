...
def generate_gradient_shape(filename, segments_u=800, segments_v=24):
    mtl_filename = filename.replace('.obj', '.mtl')
    
    def get_color(t):
        # Używamy fali cosinus, by t=0 i t=1 miały ten sam kolor (płynne łączenie na szwie)
        val = 0.5 - 0.5 * math.cos(t * 2 * math.pi)
        h = 0.05 + val * 0.8
...
if __name__ == "__main__":
    generate_gradient_shape("models/gradient_knot.obj")
    print("Wygenerowano models/gradient_knot.obj z gestym, plynnym gradientem MTL!")
